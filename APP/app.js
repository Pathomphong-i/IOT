...
app.use("/", (req, res) => {
    MongoClient.connect(url, function(err, db) {
        ...
        dbo.collection("pi_led_status").find({}).toArray(function(err, result) {
            ...
            var d = '</td><td style="width: 40.5px;"><a href="http://localhost:30000/pi_valve_A_status" target="_blank" rel="noopener">log</a></td><td style="width: 283px;"><form method="post" action="/post"><input type="hidden" name="topic" value="pi_valve_A_status" /><input name="status" type="submit" value="ON"><input name="status" type="submit" value="OFF"></form></form></td></tr><tr></tr><td style="width: 84px;">Valve B</td><td style="width: 139.5px; text-align: center;">';
            var e = '</td><td style="width: 40.5px;"><a href="http://localhost:30000/pi_valve_B_status" target="_blank" rel="noopener">log</a></td><td style="width: 283px;"><form method="post" action="/post"><form method="post" action="/post"><input type="hidden" name="topic" value="pi_valve_B_status" /><input name="status" type="submit" value="ON"><input name="status" type="submit" value="OFF"></form></td></tr><tr><td style="width: 84px;">valve Acid</td><td style="width: 139.5px; text-align: center;">';
            var f = '</td><td style="width: 40.5px;"><a href="http://localhost:30000/pi_valve_Acid_status" target="_blank" rel="noopener">log</a></td><td style="width: 283px;"><form method="post" action="/post"><input type="hidden" name="topic" value="pi_valve_Acid_status" /><input name="status" type="submit" value="ON"><input name="status" type="submit" value="OFF"></form></td></tr><tr><td style="width: 84px;">mix water</td><td style="width: 139.5px; text-align: center;">';
            var g = '</td><td style="width: 40.5px;"><a href="http://localhost:30000/pi_mix_water_status" target="_blank" rel="noopener">log</a></td><td style="width: 283px;"><form method="post" action="/post"><input type="hidden" name="topic" value="pi_mix_water_status" /><input name="status" type="submit" value="ON"><input name="status" type="submit" value="OFF"></form></td></tr><tr><td style="width: 84px;">pump loop</td><td style="width: 139.5px; text-align: center;">';
            var h = '</td><td style="width: 40.5px;"><a href="http://localhost:30000/pi_pump_water_loop_status" target="_blank" rel="noopener">log</a></td><td style="width: 283px;"><form method="post" action="/post"><input type="hidden" name="topic" value="pi_pump_water_loop_status" /><input name="status" type="submit" value="ON"><input name="status" type="submit" value="OFF"></form></td></tr><tr><td style="width: 84px;">pump tank</td><td style="width: 139.5px; text-align: center;">';
            var i = '</td><td style="width: 40.5px;"><a href="http://localhost:30000/pi_pump_water_tank_status" target="_blank" rel="noopener">log</a></td><td style="width: 283px;"><form method="post" action="/post"><input type="hidden" name="topic" value="pi_pump_water_tank_status" /><input name="status" type="submit" value="ON"><input name="status" type="submit" value="OFF"></form></td></tr><tr><td style="width: 84px;">LED</td><td style="width: 139.5px; text-align: center;">';
            var j = '</td><td style="width: 40.5px;"><a href="http://localhost:30000/pi_led_status" target="_blank" rel="noopener">log</a></td><td style="width: 283px;"><form method="post" action="/post"><input type="hidden" name="topic" value="pi_led_status" /><input name="status" type="submit" value="ON"><input name="status" type="submit" value="OFF"></form></form></td></tr></tbody></table><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;&nbsp;</p></body></html>';
